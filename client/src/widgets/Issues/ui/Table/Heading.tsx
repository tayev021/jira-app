...
export function Heading() {
  return (
    <thead>
      <tr className="sticky top-0 border border-gray-primary-light bg-secondary-bg text-tertiary-text z-20">
        <HeadingCell className="sticky top-0 left-0 bg-secondary-bg z-20">
          Issue
        </HeadingCell>
