...
export function SignInPage() {
  ...
  return (
    <Container>
      <div className="h-120 grid grid-cols-[minmax(min-content,1fr)_1fr] items-center gap-5 py-4 m-10 border-2 border-primary rounded-2xl bg-linear-to-r from-primary from-50% to-primary-bg to-50% shadow-lg">
        ...
        <SignInForm className="mx-auto border-none" />
      </div>
    </Container>
  );
}
